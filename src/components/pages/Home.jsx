  ...
  return (
    <div>
       <section className='py-10'>
        <h2 className='text-center text-4xl font-bold '>Celebration wear for Men</h2>
        <p className='text-center'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas quasi, voluptate quisquam cumque corporis deleniti, doloremque nisi
        </p>
        ...
        <h2 className='text-center text-4xl mt-12 font-bold '>Celebration wear for Women</h2>
        <p className='text-center'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas quasi, voluptate quisquam cumque corporis deleniti, doloremque nisi
        </p>
  ...
  <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
    <a href="#">
      <img
        ...
        src="https://kxadmin.metroshoes.com/product/359-39646407/660/359-39646407H16.jpg"
        alt=""
      />
    </a>
